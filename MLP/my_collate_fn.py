...
# data[索引到index(batch)][索引到data或者label][索引到channel]
    ...
    ## 省点内存
    del target_metric_padded,target_loss_padded, data_list, target_metric_list,target_loss_list,setting_list
    return data_tensor, target_metric_tensor, target_loss_tensor, setting_tensor
