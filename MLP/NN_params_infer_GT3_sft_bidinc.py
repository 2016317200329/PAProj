...
from Config import config_GT3_sft_bidinc
import loss
import plot
...
from utils import get_data_idx_bidinc

# torch.set_default_tensor_type(torch.FloatTensor)

reload(config_GT3_sft_bidinc)  # 必须reload！！
...
opt = config_GT3_sft_bidinc.DefaultConfig()
...
def get_model_save_path(flag,seed):
    model_params_MLP = opt.net_root_path + "NN_params_infer_GT3_sft_bidinc" + str(seed) + ".pth"
