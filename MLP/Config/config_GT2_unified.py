class DefaultConfig(object):
    ...
    ARTIFICIAL = True      # If True, use the syns dataset; If False, use the real dataset.
    ...
    if ARTIFICIAL:
        ...
        batch_size = 48  # 48is greate

        learning_rate = 1e-3                           # 1e-3, 5e-3
        lr_for_labda = 1e-3   # 给pi单独设置learning rate   # 影响其次,1e-3>5e-2
        lr_for_alpha = 1e-3   # 给mu单独设置learning rate   # 1e-2和5e-3都可以
