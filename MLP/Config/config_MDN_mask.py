class DefaultConfig(object):
    ...
    if ARTIFICIAL:
        ...
        # target_path_loss = "../data/targets_all_5_DA_P=1_N_c=2"
        ...
        # mask idx path
        val_mask_idx_path = "../data/mask_idx/mask_idx_val_seed="+str(seed)
        test_mask_idx_path = "../data/mask_idx/mask_idx_test_seed="+str(seed)
