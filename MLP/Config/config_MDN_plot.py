class DefaultConfig(object):
    ...
    seed = 407            # seeds = [3,31,204,223,407]
    ...
    if ARTIFICIAL and Conv_1_4:
        ...
        learning_rate = 5e-4
        lr_for_pi = 5e-4     # 给pi单独设置learning rate   # 影响其次,1e-3>5e-2
    ...
    if ARTIFICIAL:
        ...
        params_path_2 = "../data/SA_PT/params_seed=" + str(seed) + ".csv"
        params_path_3 = "../data/SA_PT/params_GT3_seed=" + str(seed) + ".csv"
